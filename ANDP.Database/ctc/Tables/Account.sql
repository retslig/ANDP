CREATE TABLE [ctc].[Account] (
    ...
    CONSTRAINT [FK_ctc_Account_Companies] FOREIGN KEY ([CompanyId]) REFERENCES [ctc].[Companies] ([Id]),
    CONSTRAINT [FK_ctc_Account_StatusType] FOREIGN KEY ([StatusTypeId]) REFERENCES [ctc].[StatusTypeEnum] ([Id]),
...
CREATE TRIGGER [ctc].[T_IUD_ctc_Account] ON [ctc].[Account]
...
AS BEGIN
	...
	BEGIN
		...
		(
			...
			INNER JOIN [ctc].[Account] A ON A.Id = I.Id
	...
	BEGIN
		...
		(
			...
			INNER JOIN [ctc].[Account] A ON A.Id = D.Id
