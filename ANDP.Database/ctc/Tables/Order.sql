CREATE TABLE [ctc].[Order] (
    ...
    CONSTRAINT [FK_ctc_Order_ActionType] FOREIGN KEY ([ActionTypeId]) REFERENCES [ctc].[ActionTypeEnum] ([Id]),
    CONSTRAINT [FK_ctc_Order_Companies] FOREIGN KEY ([ExternalCompanyId]) REFERENCES [ctc].[Companies] ([ExternalCompanyId]),
    CONSTRAINT [FK_ctc_Order_StatusType] FOREIGN KEY ([StatusTypeId]) REFERENCES [ctc].[StatusTypeEnum] ([Id]),
...
CREATE TRIGGER [ctc].[T_IUD_ctc_Order] ON [ctc].[Order]
...
AS BEGIN
	...
	BEGIN
		...
		(
			...
			INNER JOIN [ctc].[Order] A ON A.Id = I.Id
	...
	BEGIN
		...
		(
			...
			INNER JOIN [ctc].[Order] A ON A.Id = D.Id
