CREATE TABLE [emp].[Account] (
    ...
    CONSTRAINT [FK_emp_Account_Companies] FOREIGN KEY ([CompanyId]) REFERENCES [emp].[Companies] ([Id]),
    CONSTRAINT [FK_emp_Account_StatusType] FOREIGN KEY ([StatusTypeId]) REFERENCES [emp].[StatusTypeEnum] ([Id]),
...
CREATE TRIGGER [emp].[T_IUD_emp_Account] ON [emp].[Account]
...
AS BEGIN
	...
	BEGIN
		...
		(
			...
			INNER JOIN [emp].[Account] A ON A.Id = I.Id
	...
	BEGIN
		...
		(
			...
			INNER JOIN [emp].[Account] A ON A.Id = D.Id
