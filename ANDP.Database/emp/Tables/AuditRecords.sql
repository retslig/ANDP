CREATE TABLE [emp].[AuditRecords] (
    ...
    CONSTRAINT [FK_emp_AuditRecords_Companies] FOREIGN KEY ([CompanyId]) REFERENCES [emp].[Companies] ([Id]),
    CONSTRAINT [FK_emp_AuditRecords_EquipmentSetup] FOREIGN KEY ([EquipmentSetupId]) REFERENCES [emp].[EquipmentSetup] ([Id]),
    CONSTRAINT [FK_emp_AuditRecords_ItemTypeEnum] FOREIGN KEY ([ItemTypeId]) REFERENCES [emp].[ItemTypeEnum] ([Id])
);
