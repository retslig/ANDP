CREATE TABLE [emp].[EquipmentSettings] (
...
CREATE TRIGGER [emp].[T_IUD_emp_EquipmentSettings] ON [emp].[EquipmentSettings]
...
AS BEGIN
	...
	BEGIN
		...
		INSERT INTO [emp].[EquipmentSettingsX] 
	...
	BEGIN
		...
		(
			...
			INNER JOIN [emp].[EquipmentSettings] A ON A.Id = I.Id
			GROUP BY I.Id, A.[Version]
		)
		UPDATE [emp].[EquipmentSettings]
		SET [Version] = CTE1.FinalVersion
		FROM [emp].[EquipmentSettings] Z
	...
	BEGIN
		...
		(
			...
			INNER JOIN [emp].[EquipmentSettings] A ON A.Id = D.Id
