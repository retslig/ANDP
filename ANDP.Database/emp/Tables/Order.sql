CREATE TABLE [emp].[Order] (
    ...
    CONSTRAINT [FK_emp_Order_ActionType] FOREIGN KEY ([ActionTypeId]) REFERENCES [emp].[ActionTypeEnum] ([Id]),
    CONSTRAINT [FK_emp_Order_StatusType] FOREIGN KEY ([StatusTypeId]) REFERENCES [emp].[StatusTypeEnum] ([Id]),
...
CREATE NONCLUSTERED INDEX [_emp_dta_index_Order_8_1109578991__K8_K10_K4_K5_K7_K18_1_2_3_6_9_11_12_13_14_15_16_17_19_20]
    ON [emp].[Order]([StatusTypeId] ASC, [ActionTypeId] ASC, [ExternalCompanyId] ASC, [Priority] ASC, [ProvisionDate] ASC, [DateCreated] ASC)
...
CREATE STATISTICS [_emp_dta_stat_1109578991_1_20_10_4]
    ON [emp].[Order]([Id], [Version], [ActionTypeId], [ExternalCompanyId]);


GO
CREATE STATISTICS [_emp_dta_stat_1109578991_10_4]
    ON [emp].[Order]([ActionTypeId], [ExternalCompanyId]);


GO
CREATE STATISTICS [_emp_dta_stat_1109578991_10_4_8_1_20]
    ON [emp].[Order]([ActionTypeId], [ExternalCompanyId], [StatusTypeId], [Id], [Version]);


GO
CREATE STATISTICS [_emp_dta_stat_1109578991_18]
    ON [emp].[Order]([DateCreated]);


GO
CREATE STATISTICS [_emp_dta_stat_1109578991_2_1]
    ON [emp].[Order]([ExternalOrderId], [Id]);


GO
CREATE STATISTICS [_emp_dta_stat_1109578991_4_8]
    ON [emp].[Order]([ExternalCompanyId], [StatusTypeId]);


GO
CREATE STATISTICS [_emp_dta_stat_1109578991_5_7_18_8_10]
    ON [emp].[Order]([Priority], [ProvisionDate], [DateCreated], [StatusTypeId], [ActionTypeId]);


GO
CREATE STATISTICS [_emp_dta_stat_1109578991_8_1_20]
    ON [emp].[Order]([StatusTypeId], [Id], [Version]);


GO
CREATE STATISTICS [_emp_dta_stat_1109578991_8_5_7]
    ON [emp].[Order]([StatusTypeId], [Priority], [ProvisionDate]);
...
CREATE TRIGGER [emp].[T_IUD_emp_Order] ON [emp].[Order]
...
AS BEGIN
	...
	BEGIN
		...
		(
			...
			INNER JOIN [emp].[Order] A ON A.Id = I.Id
	...
	BEGIN
		...
		(
			...
			INNER JOIN [emp].[Order] A ON A.Id = D.Id
