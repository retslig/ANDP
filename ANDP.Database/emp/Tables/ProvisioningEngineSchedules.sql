CREATE TABLE [emp].[ProvisioningEngineSchedules] (
    ...
    CONSTRAINT [FK_emp_ProvisioningEngineSchedules_ProvisioningEngineSettings] FOREIGN KEY ([ProvisioningEngineSettingsId]) REFERENCES [emp].[ProvisioningEngineSettings] ([Id])
);
...
CREATE TRIGGER [emp].[T_IUD_emp_ProvisioningEngineSchedules] ON [emp].[ProvisioningEngineSchedules]
...
AS BEGIN
	...
	BEGIN
		...
		INSERT INTO [emp].[ProvisioningEngineSchedulesX] 
	...
	BEGIN
		...
		(
			...
			INNER JOIN [emp].[ProvisioningEngineSchedules] A ON A.Id = I.Id
			GROUP BY I.Id, A.[Version]
		)
		UPDATE [emp].[ProvisioningEngineSchedules]
		SET [Version] = CTE1.FinalVersion
		FROM [emp].[ProvisioningEngineSchedules] Z
	...
	BEGIN
		...
		(
			...
			INNER JOIN [emp].[ProvisioningEngineSchedules] A ON A.Id = D.Id
