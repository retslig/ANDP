CREATE TABLE [gdo].[Account] (
    ...
    CONSTRAINT [FK_gdo_Account_Companies] FOREIGN KEY ([CompanyId]) REFERENCES [gdo].[Companies] ([Id]),
    CONSTRAINT [FK_gdo_Account_StatusType] FOREIGN KEY ([StatusTypeId]) REFERENCES [gdo].[StatusTypeEnum] ([Id]),
...
CREATE TRIGGER [gdo].[T_IUD_gdo_Account] ON [gdo].[Account]
...
AS BEGIN
	...
	BEGIN
		...
		(
			...
			INNER JOIN [gdo].[Account] A ON A.Id = I.Id
	...
	BEGIN
		...
		(
			...
			INNER JOIN [gdo].[Account] A ON A.Id = D.Id
