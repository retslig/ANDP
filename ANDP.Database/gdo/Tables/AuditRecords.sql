CREATE TABLE [gdo].[AuditRecords] (
    ...
    CONSTRAINT [FK_gdo_AuditRecords_Companies] FOREIGN KEY ([CompanyId]) REFERENCES [gdo].[Companies] ([Id]),
    CONSTRAINT [FK_gdo_AuditRecords_EquipmentSetup] FOREIGN KEY ([EquipmentSetupId]) REFERENCES [gdo].[EquipmentSetup] ([Id]),
    CONSTRAINT [FK_gdo_AuditRecords_ItemTypeEnum] FOREIGN KEY ([ItemTypeId]) REFERENCES [gdo].[ItemTypeEnum] ([Id])
);
