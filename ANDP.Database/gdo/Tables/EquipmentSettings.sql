CREATE TABLE [gdo].[EquipmentSettings] (
...
CREATE TRIGGER [gdo].[T_IUD_gdo_EquipmentSettings] ON [gdo].[EquipmentSettings]
...
AS BEGIN
	...
	BEGIN
		...
		INSERT INTO [gdo].[EquipmentSettingsX] 
	...
	BEGIN
		...
		(
			...
			INNER JOIN [gdo].[EquipmentSettings] A ON A.Id = I.Id
			GROUP BY I.Id, A.[Version]
		)
		UPDATE [gdo].[EquipmentSettings]
		SET [Version] = CTE1.FinalVersion
		FROM [gdo].[EquipmentSettings] Z
	...
	BEGIN
		...
		(
			...
			INNER JOIN [gdo].[EquipmentSettings] A ON A.Id = D.Id
