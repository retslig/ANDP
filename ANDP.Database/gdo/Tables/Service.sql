CREATE TABLE [gdo].[Service] (
    ...
    CONSTRAINT [FK_gdo_Service_ActionType] FOREIGN KEY ([ActionTypeId]) REFERENCES [gdo].[ActionTypeEnum] ([Id]),
    CONSTRAINT [FK_gdo_Service_Order] FOREIGN KEY ([OrderId]) REFERENCES [gdo].[Order] ([Id]),
    CONSTRAINT [FK_gdo_Service_StatusType] FOREIGN KEY ([StatusTypeId]) REFERENCES [gdo].[StatusTypeEnum] ([Id]),
    CONSTRAINT [uc_ExternalServiceId_OrderId] UNIQUE NONCLUSTERED ([ExternalServiceId] ASC, [OrderId] ASC)
);


GO
CREATE NONCLUSTERED INDEX [_gdo_dta_index_Service_8_1397580017__K3_1_2_4_5_6_7_8_9_10_11_12_13_14_15_16_17_18]
    ON [gdo].[Service]([OrderId] ASC)
...
GO
CREATE STATISTICS [_gdo_dta_stat_1397580017_1_18]
    ON [gdo].[Service]([Id], [Version]);


GO
CREATE STATISTICS [_gdo_dta_stat_1397580017_1_3]
    ON [gdo].[Service]([Id], [OrderId]);


GO
CREATE STATISTICS [_gdo_dta_stat_1397580017_8_1_18]
    ON [gdo].[Service]([StatusTypeId], [Id], [Version]);


GO
CREATE STATISTICS [_gdo_dta_stat_1397580017_9_3_8]
    ON [gdo].[Service]([ActionTypeId], [OrderId], [StatusTypeId]);


GO


CREATE TRIGGER [gdo].[T_IUD_gdo_Service] ON [gdo].[Service]
...
AS BEGIN
	...
	BEGIN
		...
		(
			...
			INNER JOIN [gdo].[Service] A ON A.Id = I.Id
	...
	BEGIN
		...
		(
			...
			INNER JOIN [gdo].[Service] A ON A.Id = D.Id
