CREATE TABLE [ral].[Account] (
    ...
    CONSTRAINT [FK_ral_Account_Companies] FOREIGN KEY ([CompanyId]) REFERENCES [ral].[Companies] ([Id]),
    CONSTRAINT [FK_ral_Account_StatusType] FOREIGN KEY ([StatusTypeId]) REFERENCES [ral].[StatusTypeEnum] ([Id]),
...
CREATE TRIGGER [ral].[T_IUD_ral_Account] ON [ral].[Account]
...
AS BEGIN
	...
	BEGIN
		...
		(
			...
			INNER JOIN [ral].[Account] A ON A.Id = I.Id
	...
	BEGIN
		...
		(
			...
			INNER JOIN [ral].[Account] A ON A.Id = D.Id
