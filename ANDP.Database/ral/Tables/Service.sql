CREATE TABLE [ral].[Service] (
    ...
    CONSTRAINT [FK_ral_Service_ActionType] FOREIGN KEY ([ActionTypeId]) REFERENCES [ral].[ActionTypeEnum] ([Id]),
    CONSTRAINT [FK_ral_Service_Order] FOREIGN KEY ([OrderId]) REFERENCES [ral].[Order] ([Id]),
    CONSTRAINT [FK_ral_Service_StatusType] FOREIGN KEY ([StatusTypeId]) REFERENCES [ral].[StatusTypeEnum] ([Id]),
    CONSTRAINT [uc_ExternalServiceId_OrderId] UNIQUE NONCLUSTERED ([ExternalServiceId] ASC, [OrderId] ASC)
);


GO
CREATE NONCLUSTERED INDEX [_ral_dta_index_Service_8_1397580017__K3_1_2_4_5_6_7_8_9_10_11_12_13_14_15_16_17_18]
    ON [ral].[Service]([OrderId] ASC)
...
GO
CREATE STATISTICS [_ral_dta_stat_1397580017_1_18]
    ON [ral].[Service]([Id], [Version]);


GO
CREATE STATISTICS [_ral_dta_stat_1397580017_1_3]
    ON [ral].[Service]([Id], [OrderId]);


GO
CREATE STATISTICS [_ral_dta_stat_1397580017_8_1_18]
    ON [ral].[Service]([StatusTypeId], [Id], [Version]);


GO
CREATE STATISTICS [_ral_dta_stat_1397580017_9_3_8]
    ON [ral].[Service]([ActionTypeId], [OrderId], [StatusTypeId]);


GO


CREATE TRIGGER [ral].[T_IUD_ral_Service] ON [ral].[Service]
...
AS BEGIN
	...
	BEGIN
		...
		(
			...
			INNER JOIN [ral].[Service] A ON A.Id = I.Id
	...
	BEGIN
		...
		(
			...
			INNER JOIN [ral].[Service] A ON A.Id = D.Id
