CREATE TABLE [srtc].[Account] (
    ...
    CONSTRAINT [FK_srtc_Account_Companies] FOREIGN KEY ([CompanyId]) REFERENCES [srtc].[Companies] ([Id]),
    CONSTRAINT [FK_srtc_Account_StatusType] FOREIGN KEY ([StatusTypeId]) REFERENCES [srtc].[StatusTypeEnum] ([Id]),
...
CREATE TRIGGER [srtc].[T_IUD_srtc_Account] ON [srtc].[Account]
...
AS BEGIN
	...
	BEGIN
		...
		(
			...
			INNER JOIN [srtc].[Account] A ON A.Id = I.Id
	...
	BEGIN
		...
		(
			...
			INNER JOIN [srtc].[Account] A ON A.Id = D.Id
