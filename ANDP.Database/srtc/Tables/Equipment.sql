CREATE TABLE [srtc].[Equipment] (
    ...
    CONSTRAINT [FK_srtc_Equipment_ActionType] FOREIGN KEY ([ActionTypeId]) REFERENCES [srtc].[ActionTypeEnum] ([Id]),
    CONSTRAINT [FK_srtc_Equipment_EquipmentSetup] FOREIGN KEY ([EquipmentSetupId]) REFERENCES [srtc].[EquipmentSetup] ([Id]),
    CONSTRAINT [FK_srtc_Equipment_Item] FOREIGN KEY ([ItemId]) REFERENCES [srtc].[Item] ([Id]),
    CONSTRAINT [FK_srtc_Equipment_StatusType] FOREIGN KEY ([StatusTypeId]) REFERENCES [srtc].[StatusTypeEnum] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [_emp_dta_index_Equipment_8_382624406__K6_K4_K3_1_2_5_7_8_9_10_11_12_13_14_15_16_17_18_19_20_21]
    ON [srtc].[Equipment]([ItemId] ASC, [EquipmentItemId] ASC, [EquipmentSetupId] ASC)
...
CREATE STATISTICS [_emp_dta_stat_382624406_12]
    ON [srtc].[Equipment]([ActionTypeId]);


GO
CREATE STATISTICS [_emp_dta_stat_382624406_3_12_6_11]
    ON [srtc].[Equipment]([EquipmentSetupId], [ActionTypeId], [ItemId], [StatusTypeId]);


GO
CREATE STATISTICS [_emp_dta_stat_382624406_3_6_4]
    ON [srtc].[Equipment]([EquipmentSetupId], [ItemId], [EquipmentItemId]);


GO
CREATE STATISTICS [_emp_dta_stat_382624406_4_3]
    ON [srtc].[Equipment]([EquipmentItemId], [EquipmentSetupId]);


GO
CREATE STATISTICS [_emp_dta_stat_382624406_6_12]
    ON [srtc].[Equipment]([ItemId], [ActionTypeId]);


GO

CREATE TRIGGER [srtc].[T_IUD_srtc_Equipment] ON [srtc].[Equipment]
...
AS BEGIN
	...
	BEGIN
		...
		(
			...
			INNER JOIN [srtc].[Equipment] A ON A.Id = D.Id
