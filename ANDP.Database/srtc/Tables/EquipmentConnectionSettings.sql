CREATE TABLE [srtc].[EquipmentConnectionSettings] (
    ...
    CONSTRAINT [FK_srtc_EquipmentAuthenticationTypeEnum_EquipmentConnectionSettings] FOREIGN KEY ([EquipmentAuthenticationTypeId]) REFERENCES [srtc].[EquipmentAuthenticationTypeEnum] ([Id]),
    CONSTRAINT [FK_srtc_EquipmentConnectionTypeEnum_EquipmentConnectionSettings] FOREIGN KEY ([EquipmentConnectionTypeId]) REFERENCES [srtc].[EquipmentConnectionTypeEnum] ([Id]),
    CONSTRAINT [FK_srtc_EquipmentEncodingTypeEnum_EquipmentConnectionSettings] FOREIGN KEY ([EquipmentEncodingTypeId]) REFERENCES [srtc].[EquipmentEncodingTypeEnum] ([Id]),
    CONSTRAINT [FK_srtc_EquipmentIpVersionTypeEnum_EquipmentConnectionSettings] FOREIGN KEY ([EquipmentIpVersionTypeId]) REFERENCES [srtc].[EquipmentConnectionTypeEnum] ([Id])
);
...
CREATE TRIGGER [srtc].[T_IUD_srtc_EquipmentConnectionSettings] ON [srtc].[EquipmentConnectionSettings]
...
AS BEGIN
	...
	BEGIN
		...
		INSERT INTO [srtc].[EquipmentConnectionSettingsX] 
	...
	BEGIN
		...
		(
			...
			INNER JOIN [srtc].[EquipmentConnectionSettings] A ON A.Id = I.Id
			GROUP BY I.Id, A.[Version]
		)
		UPDATE [srtc].[EquipmentConnectionSettings]
		SET [Version] = CTE1.FinalVersion
		FROM [srtc].[EquipmentConnectionSettings] Z
	...
	BEGIN
		...
		(
			...
			INNER JOIN [srtc].[EquipmentConnectionSettings] A ON A.Id = D.Id
