CREATE TABLE [test].[ProvisioningEngineSchedules] (
    ...
    CONSTRAINT [FK_test_ProvisioningEngineSchedules_ProvisioningEngineSettings] FOREIGN KEY ([ProvisioningEngineSettingsId]) REFERENCES [test].[ProvisioningEngineSettings] ([Id])
);
...
CREATE TRIGGER [test].[T_IUD_test_ProvisioningEngineSchedules] ON [test].[ProvisioningEngineSchedules]
...
AS BEGIN
	...
	BEGIN
		...
		INSERT INTO [test].[ProvisioningEngineSchedulesX] 
	...
	BEGIN
		...
		(
			...
			INNER JOIN [test].[ProvisioningEngineSchedules] A ON A.Id = I.Id
			GROUP BY I.Id, A.[Version]
		)
		UPDATE [test].[ProvisioningEngineSchedules]
		SET [Version] = CTE1.FinalVersion
		FROM [test].[ProvisioningEngineSchedules] Z
	...
	BEGIN
		...
		(
			...
			INNER JOIN [test].[ProvisioningEngineSchedules] A ON A.Id = D.Id
