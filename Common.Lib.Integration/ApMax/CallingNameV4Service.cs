...
namespace Common.ApMax
{
    public class CallingNameV4Service
    {
        ...
        public CallingNameV4Service(EquipmentConnectionSetting setting)
        {
            ...
            //http://oasislap7:8731/Design_Time_Addresses/CallingNameService/CallingNameServiceV4/
            _callingNameService = new CallingNameServiceClient("WSHttpBinding_ICallingNameService1",
                new EndpointAddress("http://" + setting.Ip + ":" + setting.Port + "/Design_Time_Addresses/CallingNameService/CallingNameServiceV4/"));
        ...
        public void AddScreenPop(ScreenPopSubscriberType screenPopSubscriberType, string npaNxx, string description)
        {
            ...
            _callingNameService.InsertScreenPopSubscriber(_loginInformation.LoginToken, screenPopSubscriberType);
        }
