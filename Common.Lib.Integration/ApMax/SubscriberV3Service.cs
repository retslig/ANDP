...
using Common.SubscriberV3;
using InternetAccessType = Common.SubscriberV3.InternetAccessType;
using PlacementType_e = Common.SubscriberV3.PlacementType_e;
using SubscriberType = Common.SubscriberV3.SubscriberType;

namespace Common.ApMax
{
    public class SubscriberV3Service
    {
        ...
        //{
        //    return _subscriberService.GetSubscriberByBillingProv(_loginInformation.LoginToken, billingAccount, billingServiceId);
        //}

        //public List<ServiceInfoType> RetrieveSubscriberServices(Guid guid)
        //{
        ...
        public void DeleteSubscriberByDefaultPhoneNumber(string phoneNumber)
        {
