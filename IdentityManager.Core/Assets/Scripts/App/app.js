...
(function (angular) {
    ...
    app.service("users", function ($http) {
        ...
        this.createUser = function (tenant, username, password) {
            return $http.post("api/users", { tenant: tenant, username: username, password: password })
                .then(function (response) {
                    return response.data;
                },
                function (response) {
    ...
    app.controller("NewUserCtrl", function ($scope, users, meta) {
        ...
        $scope.create = function (tenant, username, password) {
            $scope.model.message = null;
            $scope.model.success = true;

            users.createUser(tenant, username, password)
